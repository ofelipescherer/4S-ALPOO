...
public class Janela extends JFrame{
	...
	//Fazer uma janela com dois botões e um label contando quantas vezes qualquer um foi pressionado. (a contagem é compartilhada entre os dois botões)
	...
	Janela(){
		...
		//Cria um behavior para os dois botões
